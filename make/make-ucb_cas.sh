...
DIR="/Users/bwood/Work/ucbdrupal/ucb_cas-6.x"
cd $DIR
if [ "$?" != 0 ]; then
...
echo "Working..." 
rm -rf cas cas_attributes ldap_integration
...
drush make -y --no-core make/ucb_cas-6.x.cas-ldap.make 
drush make -y --no-core --contrib-destination=phpcas make/ucb_cas-6.x.phpcas.make 
